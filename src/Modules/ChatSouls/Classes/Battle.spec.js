...
function classMethods() {
    ...
    describe(`getPossibleEnemies`, () => {
        ...
        `, () => {
            ...
            const enemiesDataArray_L5 = Battle.getPossibleEnemies(dummyPlayer)
    ...
    describe(`instantiateRandomEnemie`, () => {
        ...
        `, () => {
            ...
            const randomEnemieInstance = Battle.instantiateRandomEnemie(dummyPlayer)
            ...
            dummyPlayer.level = 1
            const randomEnemieInstance_2 = Battle.instantiateRandomEnemie(dummyPlayer)
    ...
    describe(`startBattle`, () => {
        ...
        `, () => {
            ...
            //1
            const dummyPlayer = new Player("Dummy Player: startBattle()")
            dummyPlayer.currentLocation = mapAreas.THE_WOODS
            dummyPlayer.level = 1
            Battle.startBattle(dummyPlayer)
            expect(Battle.battlesList.length).toBe(1)
            expect(Battle.battlesList[0].playerInstance.name).toBe(dummyPlayer.name)
