...
export default function resting(data){
    ...
    switch(playerState.secondary) {
        ...
        case ENUM.RESTING.SECONDARY.EQUIPMENT: equipment_Menu(data); break
        case ENUM.RESTING.SECONDARY.EQUIPMENT_MELEE: equipment_Melee(data); break
        case ENUM.RESTING.SECONDARY.EQUIPMENT_MELEE_INVENTORY: equipment_MeleeInventory(data); break
        case ENUM.RESTING.SECONDARY.EQUIPMENT_LONG_RANGE: equipment_LongRange(data); break
        case ENUM.RESTING.SECONDARY.EQUIPMENT_LONG_RANGE_INVENTORY: equipment_LongRangeInventory(data); break
        case ENUM.RESTING.SECONDARY.EQUIPMENT_HELMET: equipment_Helmet(data); break
        case ENUM.RESTING.SECONDARY.EQUIPMENT_HELMET_INVENTORY: equipment_HelmetInventory(data); break
        case ENUM.RESTING.SECONDARY.EQUIPMENT_BODY_ARMOR: equipment_Body(data); break
        case ENUM.RESTING.SECONDARY.EQUIPMENT_BODY_ARMOR_INVENTORY: equipment_BodyArmorInventory(data); break
        case ENUM.RESTING.SECONDARY.EQUIPMENT_GLOVES: equipment_Gloves(data); break
        case ENUM.RESTING.SECONDARY.EQUIPMENT_GLOVES_INVENTORY: equipment_GlovesInventory(data); break
        case ENUM.RESTING.SECONDARY.EQUIPMENT_BOOTS: equipment_boots(data); break
        case ENUM.RESTING.SECONDARY.EQUIPMENT_BOOTS_INVENTORY: equipment_BootsInventory(data); break
    }
}